...
def show_random_forest_prediction():
    ...
    with col2:
        ...
        year = st.slider("Year", 2015, 2035, 2024)
    ...
    with col3:
        aqi_lag_1 = st.number_input("AQI Lag 1", value=150.0)

    with col4:
        aqi_lag_6 = st.number_input("AQI Lag 6", value=145.0)

    with col5:
        aqi_lag_24 = st.number_input("AQI Lag 24", value=140.0)

    col6, col7 = st.columns(2)

    with col6:
        aqi_roll_6 = st.number_input("AQI Rolling 6", value=148.0)

    with col7:
        aqi_roll_24 = st.number_input("AQI Rolling 24", value=142.0)
